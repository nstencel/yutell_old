		...
		<a href="{$video_data.video_href}" title="{$video_data.attr_alt}">
			...
			<div class="pm-video-labels">
				...
				{if $video_data.mark_new}<span class="label label-new">YuTell</span>{/if}
                                ...
                                <span class="label label-featured">Fun  {$video_data.yt_fun}<i class="fa fa-eye"></i></span><br>
                                <span class="label label-featured">Int  <font color="white">{$video_data.yt_inte}<i class="fa fa-eye"></i></font></span><br>
                                <span class="label label-featured">Emo <font color="white">{$video_data.yt_emot}<i class="fa fa-eye"></i></font></span><br>
