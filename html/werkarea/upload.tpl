						...
						<div id="upload-video-extra">
							...
							<div class="form-group">
							  <label for="capture" class="col-md-2 control-label">{$lang.upload_video2}</label>
                                                          <!--<button name="YTThumb" type="url" id="YTThumb" value="" >Choose Picture</button> -->
                                                          <div id="modal">
...
<img id="result" src=""> 
                                                                     ...
                                                                     <a href="http://45.55.44.218/werkarea/index.php" target="_blank">Get and crop your picture</a>
