				...
				<div class="pm-section-head">
					<div class="btn-group btn-group-sort">
						...
						<ul class="dropdown-menu scrollable-menu" role="menu">
							<li><a href="{$smarty.const._URL}/YTFvideos.{$smarty.const._FEXT}">ALL</a></li>
							<li><a href="{$smarty.const._URL}/YTFvideos.{$smarty.const._FEXT}?d=YT1">Rating 0-1</a></li>
							<li><a href="{$smarty.const._URL}/YTFvideos.{$smarty.const._FEXT}?d=YT2">Rating 1-2</a></li>
							<li><a href="{$smarty.const._URL}/YTFvideos.{$smarty.const._FEXT}?d=YT3">Rating 2-3</a></li>
						</ul>
					</div>
				</div>
			</div>
