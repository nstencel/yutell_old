...
<div class="container-fluid">
	<div class="row row-page-heading">
		<div class="col-xs-8 col-sm-8 col-md-10">
			<a href="{$current_user_data.profile_videos_url}" class="btn btn-default" rel="tooltip" title="{$lang.return_to_profile}"><i class="mico mico-keyboard_arrow_left md-24"></i></a>
								...
								<div class="fileinput-preview fileinput-exists thumbnail">
									{if $video_type == 'suggested'}
										{if $video_data.image_url != ''}
											<img src="{$video_data.image_url}?cache-buster={php}echo time();{/php}" width="200" height="133" />
										{else}
