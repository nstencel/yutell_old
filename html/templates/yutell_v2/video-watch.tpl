	...
	<div class="row pm-video-control" align="center">
		<div class="col-xs-12 col-sm-12 col-md-6 " align="center">
			...
			<button class="btn btn-video {if $bin_rating_vote_value == 0 && $bin_rating_vote_value !== false}active{/if}" id="bin-rating-dislike" type="button" rel="tooltip" data-title="{$video_data.down_vote_count_formatted} {$lang._dislikes}"><i class="mico mico-thumb_down"></i> <span class="hidden-xs">{$video_data.down_vote_count_formatted}</span></button>
                        ...
                        <dt><font color="red">Yu</font>Funny <input type="text" class="rating" value="{$video_data.yt_fun}" data-min=0 data-max=3 data-step=0.5 data-size="xs" ></dt>
		...
		<div class="col-xs-12 col-sm-12 col-md-4">
			...
			<div class="{if ! $playlist && $video_data.video_player_autoplay_next_support}pm-related-with-autoplay{/if} {if $smarty.cookies.pm_autoplay_next == 'on'}with-highlight{else}without-highlight{/if}" id="pm-related">
				...
				{if $video_data.mark_new}<span class="label label-new">YuTell</span>{/if}
                                ...
                                <span class="label label-featured"><i class="icon-myspace-alt"></i><font color="Yellow"> {$related_video_data.yt_lang}</font></span> <br>
                                <span class="label label-featured"><i class="fa fa-smile-o"></i><font color="Gold"> {$related_video_data.yt_fun}<i class="fa fa-star"></i></span><br>
                                <span class="label label-featured"><i class="fa fa-info"></i> <font color="Gold"> {$related_video_data.yt_inte}<i class="fa fa-star"></i></font></span><br>
                                <span class="label label-featured"><i class="fa fa-heart"></i><font color="Gold"> {$related_video_data.yt_emot}<i class="fa fa-star"></i></font></span><br><br>
                                <span class="label label-featured"><i class="fa fa-eye"></i> <font color="Gold">{$related_video_data.views_compact}</font></span><br>
                                <span class="label label-featured"><i class="fa fa-thumbs-up"></i> <font color="Gold">{$related_video_data.likes_compact}</font></span><br>
                                <span class="label label-featured"><i class="fa fa-hourglass"></i> <font color="Gold">{$related_video_data.time}</font></span><br>                    
