							...
							<div class="form-group">
							  ...
							  <div class="col-md-10">
								<div class="fileinput fileinput-new" data-provides="fileinput">
                                                                    <div class="fileinput-new thumbnail"><img data-src="" alt=" " src="https://www.google.com" width="200" height="180"></div>
								  ...
								  <div class="fileinput-buttons">
									...
									<span class="fileinput-exists">{$lang._change}</span>
                                                                        <a href="http://45.55.44.218/werkarea/crop.html" target="_blank">Choose and crop your picture</a>
