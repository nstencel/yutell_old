				...
				<div class="pm-section-head">
					<div class="btn-group btn-group-sort">
						...
						<ul class="dropdown-menu scrollable-menu" role="menu">
							<li><a href="{$smarty.const._URL}/YTFun.{$smarty.const._FEXT}?d=YT1">Rating 0-1 Stars</a></li>
							<li><a href="{$smarty.const._URL}/YTFun.{$smarty.const._FEXT}?d=YT2">Rating 1-2 Stars</a></li>
							<li><a href="{$smarty.const._URL}/YTFun.{$smarty.const._FEXT}?d=YT3">Rating 2-3 Stars</a></li>
