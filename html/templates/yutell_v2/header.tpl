...
<link rel="stylesheet" type="text/css" media="screen" href="{$smarty.const._URL}/templates/{$template_dir}/css/jasny-bootstrap.min.css">
<link rel="stylesheet" type="text/css" media="screen" href="{$smarty.const._URL}/templates/{$template_dir}/css/melody.css">
...
<link rel="stylesheet" type="text/css" media="screen" href="{$smarty.const._URL}/templates/{$template_dir}/css/melody.rtl.css">
{/if}
	...
	<div class="row">
				...
				<li class="nav-menu-item">
					<div class="dropdown">
						...
						<ul class="dropdown-menu animated fast absoluteSlideInUp">
							...
							<a href="{$smarty.const._URL}/edit_profile.{$smarty.const._FEXT}" rel="tooltip" title="{$lang.edit_profile}" class="btn-nav-edit-profile"><i class="mico mico-settings md-16"></i></a></li>
		...
		<div class="col-xs-5 col-sm-4 col-md-4">
			<ul class="list-inline navbar-pmuser">
				...
				<li class="hidden-xs"><a class="btn btn-sm btn-default ajax-modal" data-toggle="modal" data-backdrop="true" data-keyboard="true" href="#modal-login-form">{$lang.sign_in|default:'Sign in'}</a></li>
			...
			<div class="col-sm-8 col-md-8">
				<ul class="nav nav-tabs">
					...
					<ul class="dropdown-menu animated fast absoluteSlideInUp">
						...
						<ul class="dropdown-menu animated fast absoluteSlideInUp">
						<li><a href="{$smarty.const._URL}/YTFvideos.php">YuTell Funny</a></li>
                                                <li><a href="{$smarty.const._URL}/YTEvideos.php">YuTell Emotional</a></li>
                                                <li><a href="{$smarty.const._URL}/YTIvideos.php">YuTell Interesting</a></li>
                                                <li><a href="{$smarty.const._URL}/YTLvideos.php">YuTell Language</a></li>
						</ul>
                                                </li>                                        
						...
						<ul class="dropdown-menu animated fast absoluteSlideInUp">
						<li><a href="{$smarty.const._URL}/page.php?p=10">FAQ</a></li>
                                                <li><a href="{$smarty.const._URL}/page.php?p=3">About Us</a></li>
                                                <li><a href="{$smarty.const._URL}/page.php?p=13">Using YuTell</a></li>
                                                <li><a href="{$smarty.const._URL}/page.php?p=18">Making Money</a></li>
                                                <li><a href="{$smarty.const._URL}/#">ANY Page Here Peter</a></li>
						</ul>
                                                </li>                                                
					...
					{if $logged_in}
					<li class="dropdown">
						<a href="{if $smarty.const.USER_DEVICE != 'mobile'}{$smarty.const._URL}/playlists.{$smarty.const._FEXT}{else}#{/if}" class="dropdown-toggle wide-nav-link disabled" data-target="#" role="button" data-toggle="dropdown">{$lang.my_playlists} <b class="caret"></b></a>
						<ul class="dropdown-menu animated fast absoluteSlideInUp">
