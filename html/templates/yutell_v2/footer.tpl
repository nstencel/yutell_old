...
<div class="container-fluid container-footer">
	...
	<footer>
		<div class="row row-footer-vertical">
			<div class="col-xs-12 col-sm-6 col-md-6">
				<ul class="list-inline">
					...
					<li><a href="{$smarty.const._URL}/contact_us.{$smarty.const._FEXT}">{$lang._contact|default:'Contact'}</a></li>
		...
		<div class="row row-footer-horizontal">
			...
			<p>	&copy; {$smarty.now|date_format:'%Y'} {$smarty.const._SITENAME}. {$lang.rights_reserved} {if $smarty.const._POWEREDBY == 1}{$lang.powered_by}{/if}</p>
			</div>
...
<script type="text/javascript" src="{/literal}{$smarty.const._URL}{literal}/js/swfobject.js"></script>
{/literal}

{if $p == "index" ||  $tpl_name == "video-category"}
{literal}
...
<!-- <script src="{/literal}{$smarty.const._URL}/templates/{$template_dir}{literal}/js/lightbox.dev.js" type="text/javascript"></script> -->
