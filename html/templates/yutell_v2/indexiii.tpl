...
<div id="content" >
	...
	<div class="row pm-vbwrn-list-row" >
		<div class="col-md-12" >
                    ...
                    <h4>  <font color="red">Yu</font>Funny - <font color="blue">{$featured_videos.0.yt_fun}</font> |  <font color="red">Yu</font>Interesting - <font color="blue">{$featured_videos.0.yt_inte}</font> | <font color="red">Yu</font>Language - <font color="blue">{$featured_videos.0.yt_lang}</font> | <font color="red">Yu</font>Emotional - <font color="blue">{$featured_videos.0.yt_emot}</font> </h4>
			<span class="pm-video-views"><i class="fa fa-eye"></i> {$featured_videos.0.views_compact}</span>
			<span class=""><i class="fa fa-thumbs-up"></i> {$featured_videos.0.likes_formatted}</span			
			...
			<div id="">
			<!-- Carousel items -->
				<ul class="" data-slider-id="vbwrn" data-slides="5" id="pm-carousel_vbwrn" >
	  ...
	  <div class="row" align="center">
		<div class="col-md-12" align="center">
			<div class="pm-section-head" allign="center">
