		...
		<a href="{$video_data.video_href}" title="{$video_data.attr_alt}">
			...
			<div class="pm-video-labels">
				...
				{if $video_data.mark_new}<span class="label label-new">YuTell</span>{/if}
                                ...
                                <span class="label label-featured"><i class="fa fa-smile"></i><font color="Gold"> {$video_data.yt_fun}<i class="fa fa-star"></i></span><br>
                                <span class="label label-featured"><i class="fa fa-info"></i> <font color="Gold"> {$video_data.yt_inte}<i class="fa fa-star"></i></font></span><br>
                                <span class="label label-featured"><i class="fa fa-heart"></i><font color="Gold"> {$video_data.yt_emot}<i class="fa fa-star"></i></font></span><br><br>
                                <span class="label label-featured"><i class="fa fa-eye"></i> <font color="Gold">{$video_data.views_compact}</font></span><br>
                                <span class="label label-featured"><i class="fa fa-thumbs-up"></i> <font color="Gold">{$video_data.likes_compact}</font></span><br>
                                <span class="label label-featured"><i class="fa fa-hourglass"></i> <font color="Gold">{$video_data.time}</font></span><br>
