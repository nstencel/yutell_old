		...
		<div class="col-xs-12 col-sm-12 col-md-4 pm-video-watch-sidebar">
			...
			<div class="{if ! $playlist && $video_data.video_player_autoplay_next_support}pm-related-with-autoplay{/if} {if $smarty.cookies.pm_autoplay_next == 'on'}with-highlight{else}without-highlight{/if}" id="pm-related">
				...
				{if $video_data.mark_new}<span class="label label-new">YuTell</span>{/if}
                                ...
                                <span class="label label-featured"><i class="fa fa-child"></i><font color="Yellow"> {$related_video_data.yt_lang}</font></span> <br>
                                <span class="label label-featured"><i class="fa fa-comment"></i><font color="white"> {$related_video_data.yt_fun}<i class="fa fa-star"></i></span><br>
                                <span class="label label-featured"><i class="fa fa-desktop"></i> <font color="white"> {$related_video_data.yt_inte}<i class="fa fa-star"></i></font></span><br>
                                <span class="label label-featured"><i class="fa fa-heart"></i><font color="white"> {$related_video_data.yt_emot}<i class="fa fa-star"></i></font></span><br><br>
                                <span class="label label-featured"><i class="fa fa-eye"></i> {$related_video_data.views_compact}</span><br>
                                <span class="label label-featured"><i class="fa fa-thumbs-up"></i> {$related_video_data.likes_compact}</span><br>
