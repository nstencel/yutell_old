...
<p>In using the {$smarty.const._SITENAME} Service, you must behave in a civil and respectful manner at all times. Further, you will not:</p>
<ul>
    ...
    <li>Advertise or solicit others to purchase any product or service within the {$smarty.const._SITENAME} Site (unless you are an official {$smarty.const._SITENAME} partner or advertiser and have a written agreement with {$smarty.const._SITENAME}).</li>
</ul>
<p>{$smarty.const._SITENAME} has the right, but not the obligation, to monitor all conduct on and content submitted to the {$smarty.const._SITENAME} Service.</p>
<hr />
<h3>Membership</h3>
<p>REGISTRATION: To fully use the {$smarty.const._SITENAME} Service, you must register as a member by providing a user name, password, and valid email address. You must provide complete and accurate registration information to {$smarty.const._SITENAME} and notify us if your information changes. If you are a business, government, or non-profit entity, the person whose email address is associated with the account must have the authority to bind the entity to this Agreement.</p>
...
<p>ACCOUNT SECURITY: You are responsible for all activity that occurs under your account, including any activity by unauthorized users. You must not allow others to use your account. You must safeguard the confidentiality of your password. If you are using a computer that others have access to, you must log out of your account after using the {$smarty.const._SITENAME} Service.</p>
<hr />
