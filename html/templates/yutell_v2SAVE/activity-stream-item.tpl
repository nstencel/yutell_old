<li class="media" id="activity-{$activity_meta.activity_id}">
	<span class="pull-left"><a href="{$actor_bucket.$activity_index.0.profile_url}"><img src="{$actor_bucket.$activity_index.0.avatar_url}" alt="{$actor_bucket.$activity_index.0.username}" width="60" height="60" border="0" class="media-object"></a></span>
	<div class="media-body">
		<a href="{$actor_bucket.$activity_index.0.profile_url}" class="pm-username">{$actor_bucket.$activity_index.0.name}</a>
	...
	{if $s_user_id == $actor_bucket.$activity_index.0.user_id}
		<a href="#" class="media-actions hidden-xs" id="hide-activity-{$activity_meta.activity_id}" rel="tooltip" title="{$lang.hide_from_stream}"><i class="fa fa-ellipsis-v"></i> </a>
	{/if}
</li>