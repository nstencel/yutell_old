...
(function(window, $, undefined) {
    ...
    Socials.prototype = {
        ...
        _createShareLink: function(share) {
            ...
            if(share.share == "whatsapp") {


                 var $result = $("<a>").addClass(this.shareLinkClass)
                    .attr({
                        "href": this._getShareUrl(share) + "?text=Check out this video" + " " + window.encodeURIComponent(this.url), 
                        "data-href": window.encodeURIComponent(this.url),
