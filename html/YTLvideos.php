...
if ( ! in_array($date, array('YT1', 'YT2', 'YT3', 'YT4')))
{
	$date = '';
}
...
switch ($date)
{
	...
	case 'YT3':
		...
		$sql = "SELECT COUNT(*) as total_found 
				FROM pm_videos 
				WHERE yt_lang >= '". $time_start ."' 
				  AND yt_lang <= '". $time_end ."'";
