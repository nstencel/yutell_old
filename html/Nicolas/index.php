<?php
// +------------------------------------------------------------------------+
// | YuTell ( www.yutell.com.com )
// +------------------------------------------------------------------------+
// | THIS IS NOT FREE SOFTWARE
// | If you have downloaded this software or if you have received
// | this software from someone, you are involved in an illegal activity.
// | ---
// | In such case, please contact: support@yutell.com.
// +------------------------------------------------------------------------+
// | Developed by: CaribeSoft (www.softwarecaribe.com) / conect@softwarecaribe.com
// | Copyright: (c) 2018 YuTell/CaribeSoft. All rights reserved.
// +------------------------------------------------------------------------+
session_start();
require('config.php');
