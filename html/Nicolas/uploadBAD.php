...
// | ---
// | In such case, please contact: softwaretheft@softwarecibe.com.
// +------------------------------------------------------------------------+
// | Developed by: CaribeSoft (www.softwarecaribe.com) / support@softwarecaribe.com.com
// | Copyright: (c) 2018 YuTell and CaribeSoft. All rights reserved.
// +------------------------------------------------------------------------+
...
// EZ-Converter Dev Area
// Area for MarkO and Nathan
// Code work started 12 December 2018
...
{
  if (event.origin === "http://ez-converter.com" || event.origin === "https://ez-converter.com" )
  {
    var videoPath = event.data;
