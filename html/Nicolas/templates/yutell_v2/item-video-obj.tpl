		...
		<a href="{$video_data.video_href}" title="{$video_data.attr_alt}">
			...
			<div class="pm-video-labels">
				...
				{if $video_data.mark_new}<span class="label label-new">YuTell</span>{/if}
                                ...
                                <span class="label label-featured"><i class="fa fa-arrow-circle-right"></i><font color="white"> {$video_data.yt_fun}.0<i class="fa fa-star"></i></span><br>
                                <span class="label label-featured"><i class="fa fa-arrow-circle-left"></i> <font color="white"> {$video_data.yt_inte}.0<i class="fa fa-star"></i></font></span><br>
                                <span class="label label-featured"><i class="fa fa-heart"></i><font color="white"> {$video_data.yt_emot}.0<i class="fa fa-star"></i></font></span><br><br>
