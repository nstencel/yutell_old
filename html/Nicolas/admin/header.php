...
<div class="row-fluid">
	<div class="span9">
	  <h1><a href="<?php echo _URL;?>" rel="tooltip" data-placement="right" title="Switch to front-end"><?php echo ($config['homepage_title'] == '') ? 'CaribeSoft' : htmlspecialchars($config['homepage_title']); ?></a></h1>
   </div>
	<div class="span3">
