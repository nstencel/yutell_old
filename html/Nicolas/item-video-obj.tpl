		...
		<a href="{$video_data.video_href}" title="{$video_data.attr_alt}">
			...
			<div class="pm-video-labels">
				...
				{if $video_data.mark_new}<span class="label label-new">{$lang._new}</span>{/if}
                                ...
                                <span class="label label-featured">Fun <br> <font color="Yellow">{$video_data.yt_fun}</font></span><br>
                                
                                <span class="label label-featured">Int <br> <font color="white">{$video_data.yt_inte}</font></span><br>
                                <span class="label label-featured">Emo <br> <font color="white">{$video_data.yt_emot}</font></span><br>
                                <span class="pm-video-views"><i class="fa fa-eye"></i> {$video_data.views_compact}</span><br>
                                <span class=""><i class="fa fa-thumbs-up"></i> {$video_data.likes_formatted}</span><br>
