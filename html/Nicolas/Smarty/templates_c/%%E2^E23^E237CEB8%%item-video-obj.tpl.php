<?php /* Smarty version 2.6.30, created on 2019-04-23 17:36:35
...
">
			...
			<div class="pm-video-labels">
				...
				<?php if ($this->_tpl_vars['video_data']['mark_new']): ?><span class="label label-new">YuTell</span><?php endif; ?>
                                ...
                                <span class="label label-featured"><i class="fa fa-child"></i><font color="Yellow"> <?php echo $this->_tpl_vars['video_data']['yt_lang']; ?>
</font></span> <br>
                                <span class="label label-featured"><i class="fa fa-arrow-circle-right"></i><font color="white"> <?php echo $this->_tpl_vars['video_data']['yt_fun']; ?>
.0<i class="fa fa-star"></i></span><br>
                                <span class="label label-featured"><i class="fa fa-arrow-circle-left"></i> <font color="white"> <?php echo $this->_tpl_vars['video_data']['yt_inte']; ?>
.0<i class="fa fa-star"></i></font></span><br>
                                <span class="label label-featured"><i class="fa fa-heart"></i><font color="white"> <?php echo $this->_tpl_vars['video_data']['yt_emot']; ?>
.0<i class="fa fa-star"></i></font></span><br><br>
                                <span class="label label-featured"><i class="fa fa-eye"></i> <?php echo $this->_tpl_vars['video_data']['views_compact']; ?>
</span><br>
                                <span class="label label-featured"><i class="fa fa-thumbs-up"></i> <?php echo $this->_tpl_vars['video_data']['likes_formatted']; ?>
</span><br>
