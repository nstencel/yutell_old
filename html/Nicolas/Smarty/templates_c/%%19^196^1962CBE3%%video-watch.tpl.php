				...
				<li  class="col-xs-12 col-sm-12 col-md-12">
					<div class="pm-video-thumb">
						...
						<div class="pm-video-labels">
                                ...
                                <span class="label label-featured">Fun  <?php echo $this->_tpl_vars['video_data']['yt_fun']; ?>
<i class="fa fa-star"></i></span><br>
                                <span class="label label-featured">Int  <font color="white"><?php echo $this->_tpl_vars['video_data']['yt_inte']; ?>
<i class="fa fa-star"></i></font></span><br>
                                <span class="label label-featured">Emo <font color="white"><?php echo $this->_tpl_vars['video_data']['yt_emot']; ?>
...
">
						<div class="pm-video-labels">
							<?php if ($this->_tpl_vars['popular_video_data']['mark_new']): ?><span class="label label-new"><?php echo $this->_tpl_vars['lang']['_new']; ?>
</span><?php endif; ?>
						</div>
...
"><?php echo $this->_tpl_vars['popular_video_data']['author_name']; ?>
						...
						<span class="pm-video-since"><time datetime="<?php echo $this->_tpl_vars['popular_video_data']['html5_datetime']; ?>
