...
<div class="container row-fluid" id="post-page">
	...
	<div class="span3">
		...
		<h4>Video Details</h4>
			...
			?>
			<div class="control-group">
			<label class="control-label" for="">YuTell Rating <span id="value-yt_fun"><strong><?php echo "Current Rating" ;?></strong></span> <a href="#" id="show-duration">Edit</a></label>
			<div class="controls" id="show-opt-duration">
			<input type="text" name="yt_funny" id="yt_ratings" value="<?php echo $r['yt_fun'] ;?>" size="4"  /> <small>Funny</small>
                        <input type="text" name="yt_interest" id="yt_ratings" value="<?php echo $r['yt_inte'] ;?>" size="3" class="smaller-select" /> <small>Interesting</small>
                        <input type="text" name="yt_lang" id="yt_ratings" value="<?php echo $r['yt_lang'] ;?>" size="3" class="smaller-select" /> <small>Language</small>
                        <input type="text" name="yt_emot" id="yt_ratings" value="<?php echo $r['yt_emot'] ;?>" size="3" class="smaller-select" /> <small>Emotional</small>
			<input type="hidden" name="yt_owner" id="yt_owner" value="" />
			</div>
			</div>                
