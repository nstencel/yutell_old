   ...
   <div class="row-fluid" id="help-assist">
		...
		<div class="tabbable tabs-left">
		  ...
		  <div class="tab-content">
			...
			<p></p>
			<p>Welcome to your dashboard! This page contains a quick overview of The YuTell Project.</p>
...
<ul class="unstyled dashboard-widgets dashboard-widgets-2x">
		...
		<li class="widget widget-home border-radius2 shadow-div">
		<h4>Future YuTell Admin Management Area - Reserved</h4> 
		<div class="widget-handle"><div class="widget-arrow"></div></div>
					...
					if (count($latest_videos) > 0)
					{
						foreach ($latest_videos as $time => $video)
						{
							...
							<?php endif; ?>
								...
								<?php elseif ($video['_type'] == 'flagged') : ?>
									<a href="YTmodify.php?vid=<?php echo $video['uniq_id']; ?>" class="btn btn-mini btn-link" rel="tooltip" title="Edit video"><i class="icon-pencil"></i></a>
								<?php else : ?>
									<a href="YTmodify.php?vid=<?php echo $video['uniq_id']; ?>" class="btn btn-mini btn-link" rel="tooltip" title="Edit video"><i class="icon-pencil"></i></a>
								<?php endif; ?>
