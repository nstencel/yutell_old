		...
		<h4>Video Details</h4>
			...
			<div class="controls" id="show-opt-ytrating">
				<label><input type="checkbox" name="ytrating_input" id="ytrating_input" value="1" <?php if($r['YT_Rating'] == 1) echo 'checked="checked"';?> /> Yes, YuTell Rating Happening</label>
                        ...
                        <div class="control-group">
			<label class="control-label" for="">YuFunny  Rating: <span id="value-yt-fun"><strong><?php echo $r['yt_fun'];?></strong></span> <a href="#" id="show-yt-fun"></a></label>
                        
			<input type="hidden" name="yt_fun" value="<?php echo $r['yt_fun'];?>" />
			Choose Number Rating: <select name="yt_fun_input"> 				        
			...
			Choose Number Rating: <select name="yt_inte_input"> 				        
                                        <option value="0">0</option>
                                        <option value="0.5">0.5</option>
                                        <option value="1.0">1.0</option>
                                        <option value="1.5">1.5</option>
                        ...
                        <div class="control-group">
			<label class="control-label" for="">YuEmotional  Rating(Current): <span id="value-yt-emot"><strong><?php echo $r['yt_emot'];?></strong></span> <a href="#" id="show-yt-emot"></a></label>
                        
                        <input type="hidden" name="yt_emot" value="<?php echo $r['yt_emot'];?>" />
                        Choose Number Rating: <select name="yt_emot_input"> 				        
                                        <option value="0">0</option>
                                        <option value="0.5">0.5</option>
                                        <option value="1.0">1.0</option>
                                        <option value="1.5">1.5</option>
			...
			<input type="hidden" name="yt_lang" value="<?php echo $r['yt_lang'];?>" />
                         Choose Language Rating:<select name="yt_lang_input">
