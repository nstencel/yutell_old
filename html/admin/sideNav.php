...
<div id="wrapper">
	...
	if (is_moderator() || is_editor())
	{
		...
		{
		?>
		<li class="pm-menu has-subcats <?php echo ($menu == 'raters') ? 'active' : ''; ?>">
		<a href="YTRate.php" class="pm-menu-parent"><div class="pm-sprite ico-videos-new"></div> <span>YuTell Ratings</span></a>
