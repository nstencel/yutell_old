...
<div class="container row-fluid" id="post-page">
	...
	<div class="span3">
		...
		<h4>Video Details</h4>
			...
			<input type="number" name="yt_funny" id="yt_ratings" value="" size="3" class="smaller-select" /> <small>Funny</small>
                        <input type="number" name="yt_interest" id="yt_ratings" value="" size="3" class="smaller-select" /> <small>Interesting</small>
                        <input type="number" name="yt_lang" id="yt_ratings" value="" size="3" class="smaller-select" /> <small>Language</small>
                        <input type="number" name="yt_emot" id="yt_ratings" value="" size="3" class="smaller-select" /> <small>Emotional</small>
