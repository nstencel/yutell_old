...
//require_once('werkarea/index.php');
// Area for pop-up Thumbnail Creation - MarkO December 2019



// END Area for pop-up Thumbnail Creation - MarkO
...
echo '<img src="'.$data.'" class="img-thumbnail" />';
